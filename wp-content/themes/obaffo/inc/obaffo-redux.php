<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'Obaffo Theme Options', 'redux-framework-demo' ),
        'page_title'           => __( 'Obaffo Theme Options', 'redux-framework-demo' ),
...
Redux::setSection($opt_name,array(
    ...
    'desc'=>'Copyright Text Option',
    'subsection'=>true,
    'fields'=>array(
        array(
            'id'=>'copyright_option',
            'title'=>'Copyright Text',
            'desc'=>'Write a copyright text',
           
            'type'=>'editor',
            'default'=>'©All Rights Reserved By Obaffo.com',
